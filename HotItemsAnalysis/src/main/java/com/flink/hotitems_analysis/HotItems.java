...
import com.flink.hotitems_analysis.beans.ItemViewCount;
import com.flink.hotitems_analysis.beans.UserBehavior;
...
public class HotItems {
	public static void main(String[] args) throws Exception {
		...
		// 2. 读取数据，创建DataStream
        DataStream<String> inputStream = env.readTextFile("D:\\env\\flink-1.12.0-src\\flink-1.12.0\\UserBehaviorAnalysis\\HotItemsAnalysis\\src\\main\\resources\\UserBehavior.csv");
